	...
	<tr>
		<td>
			<a target="_blank" :href="`https://solscan.io/tx/${txn.signature}`">
				<i v-if="(txn.err !== null && txn.error) || txn.error || txn.err" class="fa fa-eye-slash red d-none d-md-inline-block"></i>
				<i v-else class="fa fa-eye d-none d-md-inline-block"></i>
